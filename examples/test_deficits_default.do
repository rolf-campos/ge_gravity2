...
ge_gravity iso_o iso_d flow partial_effect, theta(5.03) gen_X(X1) gen_w(W1) gen_P(P1) multiplicative
ge_gravity2 iso_o iso_d flow partial_effect, theta(5.03) psi(0) gen_X(X2) gen_P(P2) gen_w(W2)
di e(Xi_hat)
...
ge_gravity2 iso_o iso_d flow partial_effect, theta(5.03) psi(1.24) gen_X(X2) gen_P(P2) gen_w(W2)
